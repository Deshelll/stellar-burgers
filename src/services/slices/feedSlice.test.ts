...
describe('[feedSlice]', () => {
    ...
    it('fulfilled', () => {
        ...
        const state = reducer(initialState, fetchOrders.fulfilled(order, '', undefined));
    ...
    it('rejected', () => {
        const state = reducer(initialState, fetchOrders.rejected(new Error('error'), '', undefined, 'error'));
