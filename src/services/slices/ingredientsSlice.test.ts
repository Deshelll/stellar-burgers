...
describe('[ingredientsSlice]', () => {
    ...
    it('fulfilled', () => {
        ...
        const state = reducer(initialState, fetchIngredients.fulfilled(ingredients, '', undefined));
    ...
    it('rejected', () => {
        ...
        const state = reducer(initialState, fetchIngredients.rejected(new Error('err'), '', undefined, err));
