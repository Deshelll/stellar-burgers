import reducer, {addIngredient, removeIngredient, moveIngredient, initialState} from './constructorSlice';
...
describe('[constructorSlice]', () => {
    ...
    it('Перемещение ингредиента', () => {
        ...
        const state = reducer(stateWithIngredients, moveIngredient({start: 0, end: 2}));
        const uuid = state.constructorItems.ingredients.map((ingredient) => ingredient.uuid);
